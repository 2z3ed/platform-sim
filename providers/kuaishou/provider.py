...
class KuaishouProvider(BaseProvider):
    def __init__(
        ...
        base_url: str = "https://open.kuaishou.com",
    ):
        super().__init__(mode)
    ...
    def _mock_get_shipment(self, order_id: str) -> Dict[str, Any]:
        return {
            "order_id": order_id,
            "shipment_id": f"KS_SHIP_{order_id}",
            "status": "signed",
            "company": "中通快递",
    ...
    def get_conversation(self, conversation_id: str) -> Dict[str, Any]:
        raise NotImplementedError("Kuaishou does not support conversation API")

    def list_messages(self, conversation_id: str, limit: int = 100) -> Dict[str, Any]:
        raise NotImplementedError("Kuaishou does not support message API")
